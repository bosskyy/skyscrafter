...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            ['name' => 'Gantungan Kunci Photostrip', 'price' => 15000, 'desc' => 'Gantungan kunci dengan desain photostrip custom. Upload 3 atau 6 foto sesuai desain pilihan Anda.', 'image' => 'Gantungan Kunci Photostrip.png'],
        ];
